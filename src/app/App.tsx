        ...
        <div className="relative z-10 max-w-4xl mx-auto px-8 py-20">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-12 leading-relaxed">
              GILMTOPIA is a three-day journey into festival utopias and
              psychedelic space. Immerse yourself in a world where music, art,
              and consciousness converge to create an unforgettable experience
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Journey through interdimensional soundscapes curated by visionary
              artists from across the cosmos. Experience live visual projections
              that respond to your energy, explore interactive art installations
              that blur the line between observer and participant, and connect
              with a community of fellow travelers seeking transformation.
            </p>
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              This isn't just a festival—it's a portal to new dimensions of
              collective consciousness. Whether you're dancing under the stars,
              meditating in our sacred spaces, or simply absorbing the
              vibrations, GILMTOPIA promises to expand your perception of what's
              possible when we come together in celebration of art, music, and
